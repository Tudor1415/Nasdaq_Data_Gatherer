...
for symbol in os.listdir("../DATA/data_per_symbol/"):
    ...
    try:
        ...
        print(f"Error balance_sheet_df {symbol}!")
    try:
        ...
        print(f"Error cash_flow_df {symbol}!")
    try:
        ...
        print(f"Error edgar_8k_df {symbol}!")
    try:
        ...
        print(f"Error historical_prices {symbol}!")
    try:
        ...
        print(f"Error holders_detailed_profile_static_df {symbol}!")
    try:
        ...
        print(f"Error income_statement_df {symbol}!")
    try:
        ...
        print(f"Error institutional_holders_df_0_static {symbol}!")
    try:
        ...
        print(f"Error major_holders_df_static {symbol}!")
    try:
        ...
        print(f"Error profile_dict_df_static {symbol}!")
    try:
        ...
        print(f"Error recommandations_dict_static_df {symbol}!")
    try:
        ...
        print(f"Error summary_df_static {symbol}!")
    try:
        ...
        print(f"Error sustainability_df_static {symbol}!")
    try:
        ...
        print(f"Error yahoo_earnings_estimate_df_static {symbol}!")
    try:
        ...
        print(f"Error yahoo_growth_estimate_df_static {symbol}!")
    try:
        ...
        print(f"Error yahoo_revenue_estimate_df_static {symbol}!")
    try:
        ...
        print(f"Error yahoo_risk_static_df_static {symbol}!")
